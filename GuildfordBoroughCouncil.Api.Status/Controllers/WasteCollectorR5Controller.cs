...
using GuildfordBoroughCouncil.Api.Status.WasteCollectorR5;

namespace GuildfordBoroughCouncil.Api.Status.Controllers
{
    [RoutePrefix("waste-collector/v5")]
    public class WasteCollectorR5Controller : ApiController
    {
        ...
        private WasteCollectorAPIWebServiceSoapClient Service
        {
            get
            {
                return new WasteCollectorAPIWebServiceSoapClient("WasteCollectorAPIWebServiceSoapR5");
            }
        }
